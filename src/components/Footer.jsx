...
const Footer = () => {
    return (
        <footer className="bg-[#1e1e1d] text-[#a3a3a3] py-12 px-6 md:px-16 font-sans mt-[70vh]">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                
                {/* Column 1: Brand & Socials */}
                <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-2 text-[#7c66dc] font-bold text-xl">
                        ...
                        <span className="text-white">Idea<span className="text-[#7c66dc]">Vault</span></span>
                    </div>
